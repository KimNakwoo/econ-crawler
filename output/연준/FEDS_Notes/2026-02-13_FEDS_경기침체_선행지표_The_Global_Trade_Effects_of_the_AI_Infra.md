# FEDS Notes - The Global Trade Effects of the AI Infrastructure Boom
...
AI 관련 국제 무역의 정의는 매우 다양합니다. WTO 분류에 따라 AI 관련 제품은 원시 실리콘 및 반도체 제조 장비부터 AI 애플리케이션을 지원하는 고급 서버에 이르기까지 약 100개의 제품 라인을 포함합니다. 이러한 카테고리는 AI 관련 상품을 식별하는 데 유용하지만 광범위한 디지털화 추세와 관련된 비AI 제품의 상당 부분도 포함합니다. AI 관련 거래를 정확하게 측정하는 것은 다음과 같은 여러 요인으로 인해 어렵습니다.

이러한 한계를 해결하기 위해 우리는 AI 컴퓨팅 용량 구축과 직접적으로 연결된 구성 요소에 초점을 맞춘 AI 관련 거래에 대해 보다 좁고 목적에 맞게 분류된 분류를 개발합니다. 구체적으로 훈련 및 추론을 포함하여 AI 데이터 센터 작업에 필수적인 서버, 그래픽 카드 및 관련 부품을 포괄하는 세 가지 HS-6 범주에 집중합니다(표 1). 이러한 코드를 통합하면 첨단 AI 개발과 관련성이 낮은 첨단 기술 제품을 제외하는 데 도움이 되며 위에서 언급한 분류 문제를 부분적으로 해결할 수 있습니다.
...
이 분류는 AI 인프라 구축과 관련된 핵심 하드웨어 구성 요소를 포착하는 것을 목표로 하지만 몇 가지 제한 사항이 없는 것은 아닙니다. 한편으로는 다른 HS 카테고리로 분류된 관련 상품을 생략함으로써 AI 관련 거래를 과소평가할 수도 있다. 반면, 선택된 HS 코드에는 AI가 아닌 제품도 포함될 수 있기 때문에 결과 측정은 엄격하게 AI 관련 활동에 기인한 무역 흐름을 과장할 수 있습니다. 다음 섹션에서 AI 관련 무역은 특히 이 세 가지 HS-6 코드의 거래를 의미합니다.

최근 AI 관련 투자의 급증으로 인해 AI 관련 제품에 대한 정의에 대한 수요가 크게 증가했으며, 2025년 상반기에 해당 제품에 대한 거래액은 2,720억 달러 이상으로 2024년 상반기에 비해 65% 증가했습니다. 그림 2A는 2024년 이후 AI 관련 수입량이 두 배 이상 증가했으며, 2024년에는 지속적인 성장이 있었고 2025년에는 수입이 크게 급증했다는 것을 보여줍니다. 프론트로딩으로 인해. 그 이후로 수입량은 2025년 7월까지 지속적으로 높은 수준으로 크게 횡보했습니다.
...
참고: 인공 지능(AI) 관련 수출은 HS(Harmonized System) 코드 8471.50, 8471.80 및 8473.30의 합계로 측정되며, 여기에는 기타 제품, 서버, 그래픽 처리 장치 및 AI 하드웨어 관련 부품이 포함됩니다. 이러한 데이터는 다른 HS 카테고리에 포함된 일부 AI 관련 제품을 생략할 수 있기 때문에 AI 관련 거래 흐름을 과소평가할 수 있습니다. 그러나 이러한 HS 코드는 AI가 아닌 제품도 포착하기 때문에 AI 관련 제품의 거래 흐름을 과대평가할 수도 있습니다. 데이터는 월별 데이터이며 2025년 7월까지 연장됩니다.
...
AI 인프라에 대한 투자가 지속적으로 확대됨에 따라 AI 관련 무역은 앞으로도 글로벌 무역 환경의 중요한 특징으로 남을 가능성이 높습니다. 데이터 센터의 구축과 전문 하드웨어에 대한 관련 수요는 글로벌 무역이 더욱 광범위한 역풍에 직면하더라도 무역 흐름을 형성하고 주요 공급업체 경제의 성장을 지원하도록 설정되었습니다. 결과적으로, 기술 변화가 어떻게 국제 무역 패턴을 재편하고 글로벌 성장 역학에 영향을 미치는지 이해하려면 AI 관련 무역에 대한 지속적인 관심이 필수적입니다.
...
세계무역기구. " 세계 무역 전망 및 통계: 2025년 10월 PDF ." 세계무역기구(WTO), 2025년 10월 7일.
...
2. GPU 클러스터 성능에 대한 데이터는 Epoch AI 데이터베이스 내에서 발견된 모든 시스템의 16비트 O/P의 합계를 나타냅니다. Epoch AI의 이 클러스터 성능은 계획된 시스템의 컴퓨팅 용량 추정치를 나타내며 작성자나 연방준비제도 이사회의 AI 관련 컴퓨팅 용량에 대한 예측으로 간주되어서는 안 됩니다. 데이터는 계획된 시스템의 세부 사항이 제공되는 대로 업데이트될 수 있습니다.  텍스트로 돌아가기
...
## 📄 영문 원본
François de Soyres , Alex Haag, Mike Liu and  Eva Van Leemput 1
...
---
*출처: https://www.federalreserve.gov/econres/notes/feds-notes/the-global-trade-effects-of-the-ai-infrastructure-boom-20260213.html | 수집: 2026-06-10 01:36 | 지표: FEDS_NOTES*
