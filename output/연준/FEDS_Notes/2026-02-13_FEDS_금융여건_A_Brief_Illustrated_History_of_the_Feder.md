# FEDS Notes - A Brief Illustrated History of the Federal Reserve's Balance Sheet
...
산업, 상업, 농업(모든 계절적 변동 및 우발 상황 포함)의 요구에 국가의 신용 메커니즘 및 시설을 보다 완벽하게 적용하는 것이 중앙은행 관리의 지속적인 목표가 되어야 합니다.
...
발표된 금리 목표와 부족한 준비금을 사용한 통화 정책의 시행은 2008년까지 계속되었습니다. 이 기간 동안 재무부는 대차대조표의 자산 측면을 지배했고 통화는 부채 측면을 지배했으며, 재무부는 통화 수요의 변화를 추적했습니다. 14 통화 수요도 감소를 멈추고 심지어 약간 증가했는데, 이는 아마도 소련 붕괴와 아르헨티나의 잇따른 위기에 따른 미국 지폐에 대한 국제적 수요 때문일 것입니다(Judson(2012)). GDP와 관련하여 연준의 대차대조표는 초기와 거의 같은 규모(GDP의 5~10%)였습니다.
...
그 후, 연준은 장기 이자율을 낮추는 것을 목표로 일련의 자산 매입 프로그램에 착수했습니다. 그러나 정의상 대차대조표는 균형을 이루어야 하기 때문에 이러한 증가는 예금 기관의 예금 증가와 일치합니다. 16 통화 수요는 또한 리먼 브라더스(Lehman Brothers)가 파산하면서 새로운 상승 추세를 시작했습니다(Judson(2012)). 이는 부분적으로는 미국 지폐에 대한 국제적 수요 때문이기도 하지만 불확실성에 대한 일반적인 대응이기도 합니다. 대차대조표 규모는 2014년 GDP의 25%를 조금 넘는 수준으로 최고조에 달했으나 정책 '정상화'를 향한 움직임이 시작되면서 줄어들기 시작했습니다. 재무부 및 기관 증권 보유는 매각되지 않았지만 완전 대체 미만으로 만기가 허용되었습니다. 2014년부터 2019년까지 5년 동안 대차대조표는 GDP의 약 25%에서 20% 미만으로 줄어들었습니다.
...
연준 정책 관리의 역사는 길고 풍부하지만 대차대조표의 역사는 2007년부터만 표시되는 경우가 많습니다. 이러한 접근 방식은 부분적으로 편의상의 문제입니다. 대부분의 온라인 데이터 소스는 2000년대 중반에 시작됩니다. 그러나 Bao et al.이 편집한 더 긴 시리즈는 다음과 같습니다. 좀 더 길게 볼 수 있으며 시간이 지남에 따라 대차대조표의 크기와 구성이 변하는 것이 예외가 아닌 일반적인 현상임을 보여줍니다.
...
Keister, Todd, James McAndrews(2009), "은행이 너무 많은 초과 준비금을 보유하고 있는 이유는 무엇입니까?(PDF)" 뉴욕 연방준비은행: 직원 보고서 380.
