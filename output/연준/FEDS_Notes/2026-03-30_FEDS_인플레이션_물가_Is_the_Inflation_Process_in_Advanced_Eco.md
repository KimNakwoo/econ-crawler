# FEDS Notes - Is the Inflation Process in Advanced Economies Different After the Pandemic?
...
참고: 헤드라인 및 근원 인플레이션은 미국, 캐나다, 영국의 경우 CPI 지수로 측정되고 유로의 경우 HICP 지수로 측정됩니다. 핵심 CPI에는 미국과 캐나다의 식품과 에너지를 제외한 모든 항목과 영국과 유로 지역의 식품, 에너지, 주류, 담배를 제외한 모든 항목이 포함됩니다. 모든 국가에 대한 데이터는 2026년 1월까지 연장됩니다. 누락된 2025년 10월 미국 CPI 데이터는 선형 보간을 통해 추정되었습니다.

출처: Haver Analytics; 연방준비제도이사회 직원 계산.

근원 인플레이션은 비슷한 궤적을 따랐지만 좀 더 점진적으로 완화되었습니다. 비록 최고치에는 미치지 못하지만 핵심 인플레이션은 이들 국가 전체에서 2% 이상을 유지하고 있습니다. 이는 미국과 캐나다에서 근원 인플레이션이 평균 약 2%, 유로 지역과 영국에서 2% 미만이었던 팬데믹 이전 시기와 대조됩니다. 최근 표제 지표와 핵심 지표 사이의 차이는 디스인플레이션의 일부가 에너지 가격 완화를 반영한 ​​반면, 근본적인 가격 압력은 더욱 지속되는 것으로 입증되었음을 시사합니다.
...
인플레이션 폭의 관찰된 변화는 근본적인 인플레이션 과정이 변경되었는지 여부에 대한 의문을 제기합니다. 포스트 팬데믹 기간을 벤치마킹하기 위해 인플레이션이 상대적으로 낮고 안정적인 기간인 2000~2019년 동안 인플레이션과 확산지수의 관계를 추정합니다.
...
이제 우리는 근원 인플레이션과 확산 꼬리 사이의 팬데믹 이전 관계에서 내재된 잔차를 조사합니다. 즉, 2020년 이전 표본에 대해 추정된 계수를 사용하여 2020년 이후의 실제 근원 인플레이션을 0% 미만 및 3% 이상의 구성요소 비중과 함께 팬데믹 이전 역사적 연관성에 의해 예측된 수준과 비교합니다.
...
가장 눈에 띄는 결과는 아래쪽 꼬리에 관한 것입니다. 경제 전반에 걸쳐 인플레이션이 0% 미만인 구성 요소의 비율은 지속적으로 긍정적인 잔차와 관련이 있습니다. 즉, 철저한 가격 하락 정도를 고려하더라도 핵심 인플레이션은 역사적 관계에서 예측하는 것보다 더 강했습니다. 즉, 디스인플레이션 요소의 존재는 팬데믹 이전보다 총 핵심 인플레이션을 낮추는 데 덜 효과가 있습니다.

위쪽 꼬리의 경우 그림이 더 이질적입니다. 유로 지역에서는 3% 이상의 점유율과 관련된 잔차가 거의 0으로 돌아왔습니다. 미국과 캐나다에서는 완만하게 긍정적인 수준을 유지하고 있지만 줄어들고 있는 것으로 보이는 반면, 영국에서는 지속적으로 높은 근원 인플레이션과 일치하는 높은 수준을 유지하고 있습니다.

전반적으로, 우리의 특정 분석의 증거는 분포의 일시적인 확대보다는 분산이 총체적 결과로 변환되는 방식의 변화를 더 많이 나타냅니다. 4 이 결과는 총 인플레이션과 카테고리별 가격 변화 분포 사이의 연관성 변화를 반영하며, 이는 기본 인플레이션 과정이 진화하고 있음을 시사합니다. 중요한 것은 이것이 중앙은행이 2% 목표를 달성할 수 없다는 것을 의미하지 않는다는 것입니다. 특히 전염병 이전의 관계는 목표를 밑도는 경향이 있는 인플레이션과 연관되어 있었기 때문입니다. 인플레이션 폭을 측정하는 다양한 경험적 접근 방식도 다른 결론을 도출할 수 있습니다.
...
전반적으로, 그림 5는 주택이 북미 지역에 불균형적으로 영향을 미치고 상품 압력이 지역에 따라 달라지면서 이제 확산 증가의 상당 부분을 서비스가 차지한다는 것을 나타냅니다.
...
참고: 단면적 차이는 특정 연도 및 월 내 CPI 항목의 총 개수를 표본으로 사용하여 구성됩니다. 모든 국가에 대한 데이터는 2026년 1월까지 연장됩니다. 누락된 2025년 10월 미국 CPI 데이터는 선형 보간을 통해 추정되었습니다.
...
## 📄 영문 원본
François de Soyres , Avani Pradhan, and  Zina Saijid 1
...
Housing services remain a key contributor in the United States and Canada, where owner-occupied housing has a larger weight, amplifying regional differences. Goods inflation is also more prevalent than before the pandemic—particularly in North America, where policy factors such as tariffs may contribute—but is more moderate elsewhere.
